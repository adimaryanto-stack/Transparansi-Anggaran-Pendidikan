            ...
            <main className="flex-1 flex items-center justify-center p-4">
                <div className="w-full max-w-[480px] bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
                    <div className="p-8 sm:p-10 flex flex-col gap-6">
                        <div>
                            <h1 className="text-2xl font-black text-slate-900">Daftar Akun Sekolah</h1>
                            <p className="text-slate-500 text-sm mt-1">Mulai transparansi anggaran di sekolah Anda.</p>
                        </div>
                        ...
                        {success ? (
                            <div className="bg-emerald-50 border border-emerald-100 text-emerald-700 px-6 py-8 rounded-2xl text-center flex flex-col items-center gap-4 animate-in zoom-in-95">
                                <span className="material-symbols-outlined text-4xl">mark_email_read</span>
                                <h3 className="font-bold text-lg">Cek Email Anda</h3>
                                <p className="text-sm opacity-90">Kami telah mengirimkan link verifikasi ke email <strong>{email}</strong>. Silakan verifikasi akun Anda sebelum login.</p>
                                <button
                            ...
                            <>
                                <form className="flex flex-col gap-5" onSubmit={handleSignup}>
                                    <div className="flex flex-col gap-2">
                                        <label className="text-slate-700 text-sm font-bold">Email Sekolah</label>
                                        <input
                                    ...
                                    <button
                                        ...
                                        disabled={loading}
                                    >
                                        {loading ? <div className="h-5 w-5 border-2 border-white/30 border-t-white rounded-full animate-spin"></div> : "Daftar Sekarang"}
                                    </button>
                                </form>

                                <div className="relative my-2">
                                    <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-slate-100"></div></div>
                                    <div className="relative flex justify-center text-xs uppercase"><span className="bg-white px-2 text-slate-400 font-bold">Atau daftar dengan</span></div>
                                </div>
