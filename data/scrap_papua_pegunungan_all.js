...
// Mapping from Kemendikbud regency code to BPS/Kepmendagri regency code and name for Papua Pegunungan
const REGENCY_MAPPING = {
  '380100': { bpsCode: '9501', name: 'Kabupaten Jayawijaya' },
  '380200': { bpsCode: '9502', name: 'Kab Pegunungan Bintang' },
  '380300': { bpsCode: '9503', name: 'Kabupaten Yahukimo' },
  '380400': { bpsCode: '9504', name: 'Kabupaten Tolikara' },
  '380500': { bpsCode: '9505', name: 'Kabupaten Mamberamo Tengah' },
  '380600': { bpsCode: '9506', name: 'Kabupaten Yalimo' },
  '380700': { bpsCode: '9507', name: 'Kabupaten Lanny Jaya' },
  '380800': { bpsCode: '9508', name: 'Kabupaten Nduga' },
};
...
async function scrapeLevel(eduLevel) {
  ...
  console.log(`\n${'='.repeat(60)}`);
  console.log(`📚 Scraping ${label} (${urlSegment}) for Prov. Papua Pegunungan`);
...
async function main() {
  console.log('🚀 Starting FULL Scraper for Prov. Papua Pegunungan');
  ...
  // Save JSON
  const jsonPath = path.join(__dirname, 'papua_pegunungan_all_schools.json');
