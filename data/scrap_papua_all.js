...
// Mapping from Kemendikbud regency code to BPS/Kepmendagri regency code and name for Papua
const REGENCY_MAPPING = {
  '250100': { bpsCode: '9103', name: 'Kabupaten Jayapura' },
  '250200': { bpsCode: '9106', name: 'Kabupaten Biak Numfor' },
  '250300': { bpsCode: '9105', name: 'Kabupaten Kepulauan Yapen' },
  '251900': { bpsCode: '9110', name: 'Kabupaten Sarmi' },
  '252000': { bpsCode: '9111', name: 'Kabupaten Keerom' },
  '252600': { bpsCode: '9115', name: 'Kabupaten Waropen' },
  '252700': { bpsCode: '9119', name: 'Kabupaten Supiori' },
  '252800': { bpsCode: '9120', name: 'Kabupaten Mamberamo Raya' },
  '256000': { bpsCode: '9171', name: 'Kota Jayapura' },
};
...
async function scrapeLevel(eduLevel) {
  ...
  console.log(`\n${'='.repeat(60)}`);
  console.log(`📚 Scraping ${label} (${urlSegment}) for Prov. Papua`);
...
async function main() {
  console.log('🚀 Starting FULL Scraper for Prov. Papua');
  ...
  // Save JSON
  const jsonPath = path.join(__dirname, 'papua_all_schools.json');
